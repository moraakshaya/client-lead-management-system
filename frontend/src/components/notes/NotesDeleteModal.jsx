...
export default function NotesDeleteModal({ isOpen, onClose, note }) {
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-container edit-modal-container" style={{ maxWidth: '400px' }} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-footer edit-modal-footer">
          ...
          <button type="button" className="btn-save" style={{ backgroundColor: 'var(--danger)' }} onClick={handleDelete}>Delete Note</button>
        </div>
      </div>
    </div>
  );
