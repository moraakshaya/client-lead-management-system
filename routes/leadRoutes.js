...
const { createLead, getAllLeads, getLeadById, updateLead, deleteLead } = require('../controllers/leadController'); // Importing the LeadController to handle requests related to leads
